import { ILeadRepository } from "../interface/staff/ILeadRepository";
...
async getLeadByStatus(
  ...
  try {
    ...
    const matchConditions: any = { status: { $in: statusArr }, assignedAgent: new mongoose.Types.ObjectId(staffId)};
