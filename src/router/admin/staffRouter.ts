...
import { uploadSingleFile } from '../../middlewares/cloudinaryMulter'
...
router.post('/', ...uploadSingleFile, (req:Request, res:Response) => staffController.createStaff(req, res))
router.get('/', (req:Request, res:Response) => staffController.getActiveStaff(req, res))
router.patch('/:id', ...uploadSingleFile, (req:Request, res:Response) => staffController.updateStaff(req, res))
